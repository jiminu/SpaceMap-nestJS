...
$.sidebarMenu = function(menu) {
	...
	$(subMenuSelector).parent("li").find("a.dep1").attr("href", "#"); //서브메뉴가 있는 대메뉴 링크값 지우기
	...
	$(subMenuSelector).children("li.active").parent().parent("li").addClass("active");
...
$(document).ready(function () {
	$.sidebarMenu($('#hd-nav-container #nav'));
});
