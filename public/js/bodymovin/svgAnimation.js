...
loadBMAnimationClass('logo', 'img/bodymovin/logo.json');

loadBMAnimationClass('main-copy', 'img/bodymovin/main-copy.json');
loadBMAnimationClass('main-copy-fast', 'img/bodymovin/main-copy-fast.json');
